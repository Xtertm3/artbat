...
const FALLBACK_ENROLLMENTS: Enrollment[] = [
  { id: 'demo-1', courseId: 'course-guitar-101', userId: 'u-1', enrolledAt: new Date().toISOString(), progress: 65, completedLessons: ['l-1','l-2','l-3'], lastAccessedAt: new Date().toISOString(),
    course: { id: 'course-guitar-101', title: 'Guitar Foundations Bootcamp', description: '', shortDescription: '', thumbnail: '', category: 'music', subcategory: 'guitar', level: 'beginner', language: 'English', price: 0, instructor: { id: 'i-1', name: 'James Wilson', rating: 4.9 }, rating: 4.9, totalReviews: 832, totalStudents: 12420, totalLessons: 36, totalDuration: 540, modules: [], tags: ['guitar'], isPublished: true, isFeatured: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() } },
  { id: 'demo-2', courseId: 'course-tabla-101', userId: 'u-1', enrolledAt: new Date().toISOString(), progress: 28, completedLessons: ['l-1'], lastAccessedAt: new Date().toISOString(),
    course: { id: 'course-tabla-101', title: 'Tabla for Beginners', description: '', shortDescription: '', thumbnail: '', category: 'music', subcategory: 'tabla', level: 'beginner', language: 'Hindi', price: 0, instructor: { id: 'i-4', name: 'Pandit Rajan Misra', rating: 4.9 }, rating: 4.9, totalReviews: 612, totalStudents: 9800, totalLessons: 30, totalDuration: 480, modules: [], tags: ['tabla'], isPublished: true, isFeatured: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() } },
  { id: 'demo-3', courseId: 'course-bharatanatyam-101', userId: 'u-1', enrolledAt: new Date().toISOString(), progress: 10, completedLessons: ['l-1'], lastAccessedAt: new Date().toISOString(),
    course: { id: 'course-bharatanatyam-101', title: 'Bharatanatyam Foundations', description: '', shortDescription: '', thumbnail: '', category: 'dance', subcategory: 'bharatanatyam', level: 'beginner', language: 'Tamil', price: 0, instructor: { id: 'i-12', name: 'Savitha Narayanan', rating: 4.9 }, rating: 4.9, totalReviews: 748, totalStudents: 11230, totalLessons: 36, totalDuration: 540, modules: [], tags: ['Bharatanatyam'], isPublished: true, isFeatured: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() } },
  { id: 'demo-4', courseId: 'course-hindustani-101', userId: 'u-1', enrolledAt: new Date().toISOString(), progress: 100, completedLessons: ['l-1','l-2','l-3','l-4'], lastAccessedAt: new Date().toISOString(),
    course: { id: 'course-hindustani-101', title: 'Hindustani Classical Vocals', description: '', shortDescription: '', thumbnail: '', category: 'vocals', subcategory: 'hindustani', level: 'beginner', language: 'Hindi', price: 0, instructor: { id: 'i-19', name: 'Pt. Jasraj Das', rating: 5.0 }, rating: 5.0, totalReviews: 934, totalStudents: 15800, totalLessons: 42, totalDuration: 630, modules: [], tags: ['hindustani'], isPublished: true, isFeatured: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() } },
];
